...
int main(void)
{
    ...
    // send command
    stat = spi_xfer_byte(RF24_R_REGISTER | RF24_CONFIG);

	// read response
    conf = spi_xfer_byte(RF24_NOP);

    channel = spi_xfer_byte(RF24_R_REGISTER | RF24_RF_CH);
